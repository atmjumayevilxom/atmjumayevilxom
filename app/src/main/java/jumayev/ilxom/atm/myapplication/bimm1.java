...
public class bimm1 extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
    public WebView wv;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bimm1);
        ...
        wv = (WebView) findViewById(R.id.web3);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.bimm1, menu);
        return true;
    }
