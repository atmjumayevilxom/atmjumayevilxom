...
public class PochtaK extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
    public WebView wv;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pochta_k);
        ...
        wv = (WebView) findViewById(R.id.web6);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.pochta_k, menu);
        return true;
    }
